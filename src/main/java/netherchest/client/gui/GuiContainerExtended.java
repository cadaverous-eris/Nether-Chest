...
public abstract class GuiContainerExtended extends GuiScreen {

	protected RenderItemExtended extendedItemRender;
	...
	public GuiContainerExtended(Container inventorySlotsIn) {
	...
	public void setWorldAndResolution(Minecraft mc, int width, int height) {
		...
		this.extendedItemRender = RenderItemExtended.instance();
	}
